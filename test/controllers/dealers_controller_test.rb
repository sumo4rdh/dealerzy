...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post dealers_url, params: { dealer: { adress: @dealer.adress, miasto: @dealer.miasto, nazwa: @dealer.nazwa, przychody: @dealer.przychody, samochody: @dealer.samochody, telefon: @dealer.telefon, wlasciciel: @dealer.wlasciciel } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { adress: @dealer.adress, miasto: @dealer.miasto, nazwa: @dealer.nazwa, przychody: @dealer.przychody, samochody: @dealer.samochody, telefon: @dealer.telefon, wlasciciel: @dealer.wlasciciel } }
